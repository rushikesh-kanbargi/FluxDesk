...
exports.PromptosPanelProvider = void 0;
const vscode = __importStar(require("vscode"));
const api_1 = require("./api");
class PromptosPanelProvider {
        ...
        webviewView.webview.onDidReceiveMessage(async (msg) => {
            switch (msg.type) {
                ...
                case 'saveToken': {
                    ...
                    if (!valid) {
                        this._postMessage({ type: 'error', message: 'Invalid or expired token. Check your PromptOS credentials.' });
                        return;
                    }
    ...
    async activateWithSelection(toolId, text, language) {
        await vscode.commands.executeCommand('promptosPanel.focus');
...
exports.PromptosPanelProvider = PromptosPanelProvider;
PromptosPanelProvider.viewType = 'promptosPanel';
function getNonce() {
    let text = '';
...
//# sourceMappingURL=PromptosPanelProvider.js.map